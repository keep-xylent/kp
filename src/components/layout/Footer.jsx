        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-5 reveal">
            ...
            <div className="flex items-center space-x-3">
              ...
              <a href={settings?.contact_ig ? `https://instagram.com/${settings.contact_ig.replace('@', '')}` : 'https://instagram.com'} target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-white transition-colors" aria-label="Instagram">
          ...
          <div className="space-y-5 reveal">
            ...
            <p className="text-sm text-slate-500 leading-relaxed whitespace-pre-wrap">
              {settings?.contact_address || 'Griya Permata Gedangan Blok I3 No.9 Gedangan, Kabupaten Sidoarjo, Jawa Timur.'}<br />
              Telp: {settings?.contact_phone || '(021) 555-8899'}<br />
              Email: {settings?.contact_email || 'info@starconsejahtera.co.id'}
            </p>
            <a href={`https://wa.me/${waNumber}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-medium px-4 py-2 rounded-lg transition-colors">
