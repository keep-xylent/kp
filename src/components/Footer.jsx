        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6 reveal">
            <a href="#hero" className="flex items-center space-x-3">
              <img src="/images/logo_light.png" alt="STARCON Logo" className="h-10" />
            </a>
            ...
            <div className="flex items-center space-x-4">
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors" aria-label="LinkedIn Profile">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                </svg>
              </a>

              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors" aria-label="Instagram Profile">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors" aria-label="Facebook Page">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="space-y-6 reveal">
            <h4 className="font-heading font-extrabold text-base uppercase tracking-wider text-blue-500">Peta Situs</h4>
          ...
          <div className="space-y-6 reveal">
            <h4 className="font-heading font-extrabold text-base uppercase tracking-wider text-blue-500">Layanan Konstruksi</h4>
            <ul className="space-y-3 text-xs text-slate-400">
              <li><a href="#layanan" className="hover:text-white transition-colors">Konstruksi Gedung</a></li>
              <li><a href="#layanan" className="hover:text-white transition-colors">Pembangunan Jalan Hotmix/Rigid</a></li>
              <li><a href="#layanan" className="hover:text-white transition-colors">Konstruksi Jembatan Rangka Baja</a></li>
              <li><a href="#layanan" className="hover:text-white transition-colors">Sistem Irigasi & Drainase</a></li>
              <li><a href="#layanan" className="hover:text-white transition-colors">Renovasi & Retrofit Gempa</a></li>
              <li><a href="#layanan" className="hover:text-white transition-colors">Perencanaan DED & RAB</a></li>
            </ul>
          </div>

          <div className="space-y-6 reveal">
            <h4 className="font-heading font-extrabold text-base uppercase tracking-wider text-blue-500">Hubungi Langsung</h4>
            <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div className="pt-2">
              <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold px-4 py-2.5 rounded-lg shadow-md transition-all">
